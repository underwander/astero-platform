    ...
    .then(() =>
      prisma.$executeRaw`
        ALTER TABLE "ManualQuote"
          ...
          ADD COLUMN IF NOT EXISTS "demoMinPrice" DOUBLE PRECISION,
          ADD COLUMN IF NOT EXISTS "demoMaxPrice" DOUBLE PRECISION,
          ADD COLUMN IF NOT EXISTS "demoVolatility" DOUBLE PRECISION NOT NULL DEFAULT 1,
          ADD COLUMN IF NOT EXISTS "demoSpeed" INTEGER NOT NULL DEFAULT 3,
