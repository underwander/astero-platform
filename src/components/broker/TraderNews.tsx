  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-white/[0.04]">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-base font-black text-slate-950 dark:text-white">Новости трейдера</h2>
      </div>
        ...
        {news.map((item) => (
          ...
          >
            <div className="mb-3 flex items-center gap-2 text-[11px] font-bold uppercase text-slate-400">
              <span className="rounded-full bg-emerald-500/10 px-2 py-1 text-emerald-700 dark:text-emerald-300">{item.source}</span>
