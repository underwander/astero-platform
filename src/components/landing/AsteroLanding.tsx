...
const content: Record<"ru" | "en", LocaleContent> = {
  ru: {
    ...
    heroBadge: "Брокерская торговая среда",
    heroTitle: "Astero Trader Room",
    heroText:
      "Личный кабинет и торговая платформа для клиентов, которые хотят видеть рынок, операции и поддержку в одном аккуратном интерфейсе.",
    ...
    aboutEyebrow: "История Astero",
    aboutTitle: "Платформа для тех, кто хочет видеть рынок, счет и решения в одном месте.",
    aboutText: [
      "Astero создавался как цифровая торговая среда для клиентов, которым нужен понятный доступ к рынкам без перегруженного интерфейса. В основе проекта: быстрый личный кабинет, рабочий терминал, прозрачная история операций и связь с командой сопровождения.",
      "Легенда бренда строится вокруг навигации: Astero помогает клиенту не теряться в рыночном шуме, а видеть ключевые данные, контролировать сделки и держать финансовые операции под рукой.",
    ],
    advantagesEyebrow: "Преимущества",
    advantagesTitle: "Все для ежедневной работы с рынком",
    openAccount: "Открыть счет",
    advantages: [
      {
        title: "Единый кабинет",
        text: "Пополнение, вывод средств, верификация, история операций и поддержка собраны в одном рабочем пространстве.",
      },
      {
        title: "Торговый терминал",
        text: "Котировки, график, открытые позиции и история сделок доступны без лишних переходов.",
      },
      {
        title: "Контроль рисков",
        text: "Take Profit, Stop Loss и прозрачные параметры сделки помогают действовать спокойнее.",
      },
      {
        title: "Поддержка клиентов",
        text: "Обращения, изображения и уведомления позволяют быстро получать помощь от команды сопровождения.",
      },
    ],
    platformTitle: "Терминал, кабинет и CRM-процессы в единой экосистеме.",
    platformText:
      "Клиент видит баланс, доступные средства, историю пополнений и выводов, котировки и новости. Администратор управляет клиентской базой, обращениями, заявками и торговыми параметрами.",
    accountsEyebrow: "Типы счетов",
    accountsTitle: "Форматы обслуживания под разные задачи",
    ...
    accounts: [
      ...
      },
      {
        name: "Standard",
        deposit: "от $2 500",
        spread: "Расширенная аналитика",
        features: ["Быстрая обработка заявок", "Обзор рынка", "Персональные уведомления"],
      },
      {
        name: "Pro",
        deposit: "от $10 000",
    ...
    startTitle: "Регистрация занимает несколько шагов",
    steps: [
      "Создайте аккаунт и войдите в личный кабинет",
      "Заполните профиль и загрузите документы для проверки",
      "Пополните счет и откройте торговый терминал",
      "Следите за позициями, историей и заявками в кабинете",
    ],
    finalTitle: "Готовы открыть личный кабинет Astero?",
    riskText:
      "Торговля на финансовых рынках связана с риском. Оценивайте свои знания, опыт и финансовые возможности перед открытием сделок.",
    terminalLive: "Live",
  },
  en: {
    ...
    heroBadge: "Brokerage trading workspace",
    heroTitle: "Astero Trader Room",
    heroText:
      "A client cabinet and trading platform for users who want market data, operations and support in one clean interface.",
    ...
    aboutEyebrow: "Astero story",
    aboutTitle: "A platform for clients who want market, account and decisions in one place.",
    aboutText: [
      "Astero was built as a digital trading environment for clients who need clear market access without an overloaded interface. The project is centered around a fast client cabinet, a working terminal, transparent operation history and direct support communication.",
      "The brand story is built around navigation: Astero helps clients avoid market noise, see key data, control trades and keep financial operations close at hand.",
    ],
    advantagesEyebrow: "Advantages",
    advantagesTitle: "Everything for daily market work",
    openAccount: "Open account",
    advantages: [
      {
        title: "Unified cabinet",
        text: "Deposits, withdrawals, verification, operation history and support are collected in one workspace.",
      },
      {
        title: "Trading terminal",
        text: "Quotes, charts, open positions and trade history are available without unnecessary navigation.",
      },
      {
        title: "Risk control",
        text: "Take Profit, Stop Loss and transparent trade parameters help clients act with more discipline.",
      },
      {
        title: "Client support",
        text: "Tickets, image attachments and notifications help clients get assistance from the support team quickly.",
      },
    ],
    platformTitle: "Terminal, cabinet and CRM workflows in one ecosystem.",
    platformText:
      "Clients see balance, available funds, deposit and withdrawal history, quotes and news. Administrators manage the client base, support requests, financial applications and trading parameters.",
    accountsEyebrow: "Account types",
    accountsTitle: "Service formats for different goals",
    ...
    accounts: [
      ...
      },
      {
        name: "Standard",
        deposit: "from $2,500",
        spread: "Extended analytics",
        features: ["Fast request processing", "Market overview", "Personal notifications"],
      },
      {
        name: "Pro",
        deposit: "from $10,000",
    ...
    startTitle: "Registration takes only a few steps",
    steps: [
      "Create an account and enter the client cabinet",
      "Complete your profile and upload documents for verification",
      "Fund the account and open the trading terminal",
      "Track positions, history and requests in the cabinet",
    ],
    finalTitle: "Ready to open your Astero client cabinet?",
    riskText:
      "Trading financial markets involves risk. Assess your knowledge, experience and financial capacity before opening trades.",
    terminalLive: "Live",
  },
};
